...
ch10_data |> 
  ...
  labs(title = "Civic Engagement and Voting Behavior in Michigan", 
       ...
       caption = "Random sample of 5% of the data from Gerber, 
       Green, and Larimer (2008)")
```

Using the data from an experiment that tried to find out to what extent people are pushed to vote by social pressure, we want to see the causal effect on voting turnout of sending postcards in the Texas general election of 2006.
